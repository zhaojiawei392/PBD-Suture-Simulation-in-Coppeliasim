...
public:
    ...
    DQ lc1;
    DQ lc2;
    MyLineSegment robot1_link9;
    MyLineSegment robot2_link9;
    MyLineSegment robot1_link7;
    MyLineSegment robot2_link7;
    DQ bed;
    CollisionCheckMaterialBox(DQ_VrepInterface& vi):vi_(vi){};
...
private:
    ...
    void _collision_avoidance(std::vector<DQ>& future, const std::vector<DQ>& curr, const CollisionCheckMaterialBox& cc, const CollisionCheckMaterialBox& prev_cc) const;
    void _penetration_avoidance(std::vector<DQ>& future, const std::vector<DQ>& curr, const CollisionCheckMaterialBox& cc, const CollisionCheckMaterialBox& prev_cc) const;
    void _self_collision_avoidance(std::vector<DQ>& future, const std::vector<DQ>& curr, const double& safe_distance) const;

    void _calculate_future_positions(std::vector<DQ>& future, const std::vector<DQ>& curr, const std::vector<DQ>& past, const CollisionCheckMaterialBox& cc) const;
